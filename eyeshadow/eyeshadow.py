...
def ext(a,b,i):
	...
	if(b-a==1):
		...
		y.extend((ones(int(b-a+1)*i)).tolist())

def extleft(a,b,i):
	xleft.extend(arange(a,b,1).tolist())
	if(b-a==1):
		yleft.extend((ones(int(b-a)*i)).tolist())
	else:
		yleft.extend((ones(int(b-a+1)*i)).tolist())

def extright(a,b,i):
	xright.extend(arange(a,b,1).tolist())
	if(b-a==1):
		yright.extend((ones(int(b-a)*i)).tolist())
	else:
		yright.extend((ones(int(b-a+1)*i)).tolist())
    
   
file = np.loadtxt('c:\Python\Python-work\Virtual-Makeup\eyeshadow\pointeyeshadow.txt')
...
im = imread('c:\Python\Python-work\Virtual-Makeup\eyeshadow\out1.jpg')
...
figure()
im = imread('c:\Python\Python-work\Virtual-Makeup\eyeshadow\Input3.jpg')
im2 = imread('c:\Python\Python-work\Virtual-Makeup\eyeshadow\Input3.jpg')
...
image_blank = imread('c:\Python\Python-work\Virtual-Makeup\eyeshadow\Input3.jpg')
image_blank *= 0
