...
fileface = np.loadtxt('c:\Python\Python-work\Virtual-Makeup\poundation\pointface.txt')
...
im = imread('c:\Python\Python-work\Virtual-Makeup\poundation\Input2.jpg')
im2 = im.copy()
...
immask = cv2.imread('c:\Python\Python-work\Virtual-Makeup\poundation\Input2.jpg')
