...
output1 = apply_makeup(image, False, 'blush',(0,0,102), False)
output2 = apply_makeup(image, False, 'lips',(0,0,102), False)
output3 = apply_makeup(image, False, 'foundation',(0,0,102), False)
